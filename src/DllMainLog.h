...
#ifdef WIN32
	#ifdef _LOGDLL
		#define ExportedLogObject __declspec( dllexport )
		#ifdef QPAYEXT
			#define ExportedLogObjectExt __declspec( dllexport )
		#else
			#define ExportedLogObjectExt __declspec( dllimport )
		#endif
		//#define EXPIMP_TEMPLATE
	#else
		#define ExportedLogObject __declspec( dllimport )
		#define ExportedLogObjectExt __declspec( dllimport )
		//#define EXPIMP_TEMPLATE extern
	#endif
#else
	#define ExportedLogObject 
	#define ExportedLogObjectExt
	//#define EXPIMP_TEMPLATE
#endif
...
namespace FinTP
{
	...
	*/
	class ExportedLogObject VersionInfo
	{
		private : 
			/// \brief Constructor
			VersionInfo(){};
